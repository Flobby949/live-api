...
import top.flobby.live.im.core.server.common.WebSocketEncoder;
import top.flobby.live.im.core.server.handler.ws.WsImServerCoreHandler;
import top.flobby.live.im.core.server.handler.ws.WsSharkHandler;

/**
 * @author : Flobby
 * @program : live-api
 * @description : wsStarter
 * @create : 2023-12-14 13:46
 **/
...
public class WsNettyImServerStarter implements InitializingBean {
    ...
    public void startApplication() throws InterruptedException {
        ...
        LOGGER.info("WS服务启动成功，监听端口为{}", port);
